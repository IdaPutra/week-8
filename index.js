...
const gs = require('github-scraper'); // require the module
...
<html lang="en">
   <head>
      ...
      <header class="photo-header">
          ...
          <h4>Currently @ ${data.location}</h3>
          <div class="links-nav">
              <p>
                  
                  <i class="fab fa-github"> </i><a class="nav-link" href="github.com/users/${data.url}">GitHub</a>
                  <i class="fas fa-blog"> </i> <a class="nav-link" href="${data.blog}">Blog</a>
              </p>
          </div>
...
async function init() {
  ...
  try {
    ...
    const url = answers.github// a random username 
    gs(url, async function(err, data) {
